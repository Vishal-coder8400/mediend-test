...
">
  ...
  >
    <img
      src="/assets/diseases/Gynecomastia1"
      className="
        w-full
        max-w-[410px]
        ...
        <div className="max-w-[1250px] mx-auto grid grid-cols-1 md:grid-cols-3 
          ...
          <div className="md:border-r md:px-10 border-gray-300">
            ...
            <p className="text-[17px] text-gray-700 leading-[1.7] mb-4">
              Since there is no medication of Lipoma, it becomes necessary to consult a surgeon. Pristyn Care performs a minimally invasive procedure which has the following benefits:
            </p>
